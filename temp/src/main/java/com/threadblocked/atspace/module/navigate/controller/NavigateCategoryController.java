...
@Controller
@RequestMapping("/admin/modules/navigate/navigatecategory")
public class NavigateCategoryController extends BaseController{

	@Autowired
	private INavigateCategoryService navigateCategoryService;
